        ...
        setTimeout(() => {
            ...
            successMessage.innerHTML = `
                <div style="text-align: center;">
                    ...
                    <h3 style="margin-bottom: 1rem;">Terima Kasih!</h3>
                    <p style="margin-bottom: 1rem;">Saran tempat "<strong>${document.getElementById('namaTempat').value}</strong>" berhasil dikirim.</p>
                    <p style="font-size: 0.9rem; opacity: 0.9;">Kami akan meninjau rekomendasi Anda dalam 1-2 hari kerja.</p>
                </div>
            `;
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    initializeExploreAnimation(); // Tambahkan ini
